...
import RenderFigma from './RenderFigma';
import { renderFigmaHelpers } from '@/helpers/RenderFigma.helpers';
import { ITitleCarruselCardProps } from '@/interfaces/types';

const RenderFigmaWrapper: React.FC<ITitleCarruselCardProps> = ({title}) => {
...
export default RenderFigmaWrapper;
