  ...
  return (
    <footer className={styles.rocFooter}>
        ...
        <div className={styles.rocFooter2}>
          ...
          <a href="https://www.behance.net/davidrocfeler">https://www.behance.net/davidrocfeler</a>
          ...
          <a href="https://www.linkedin.com/in/davidrocfeler/">https://www.linkedin.com/in/davidrocfeler/</a>
          ...
          <a href="https://github.com/DavidRocFeler">https://github.com/DavidRocFeler</a>
        </div>
    </footer>
  )
}
